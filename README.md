<img width="295" height="180" alt="image" src="https://github.com/user-attachments/assets/48424dfd-affc-4a98-8faf-40c04f0042f9" /><img width="192" height="17" alt="image" src="https://github.com/user-attachments/assets/2bdcc41e-3184-4c28-b672-b0acd86df3a9" />


<img width="109" height="29" alt="image" src="https://github.com/user-attachments/assets/eb7a1a91-36da-40a0-b69c-45a55c18fc20" />

<img width="167" height="45" alt="image" src="https://github.com/user-attachments/assets/f7916fc7-df01-4e41-a485-249c730357c1" />
<img width="132" height="52" alt="image" src="https://github.com/user-attachments/assets/75fea9f4-13ba-4d05-9f5e-655b25772a2c" />

<img width="132" height="52" alt="image" src="https://github.com/user-attachments/assets/9143a577-c4f5-4c4b-9a2a-e1d5a1aa9705" />
<img width="295" height="180" alt="image" src="https://github.com/user-attachments/assets/f9339077-95f5-4fe1-9ea9-f97f5f1e9eba" />
update cards to move the following to the very top of the page with updated logs and location all others stay the same. 
PRIMARY
☁️
Salesforce (Amplo/Veruna)
CRM + sales management

POLICY
📄
PolicyCenter
Quote, issue, PRD, docs

QUOTE
🧮
ClearQuote
Quote setup & readiness
...
<title>NSS CL Inside Sales Hub - Complete Edition</title>
<style>
    * { box-sizing: border-box; }
    ...
    /* Style for the grid of navigation cards beneath the header */
    .nav-card-grid {
      display: grid;
    ...
    .nav-card-icon { font-size: 32px; margin-bottom: 8px; display: block; }
    .nav-card-title { font-size: 14px; font-weight: 700; }
...

        ...
        <p><em>For complete procedures, refer to the <strong>Handling Procedures</strong> site in Inside Sales Resources.</em></p>
      `;
